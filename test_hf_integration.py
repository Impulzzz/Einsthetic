...
print("Testing Hugging Face Question Generation...")
print("="*60)
...
if response.status_code == 200:
    try:
        ...
        print("\n[SUCCESS] Question generated via Hugging Face!")
        print("\nQuestion Preview:")
        ...
        if "MOCK" in question.get('question', ''):
            print("\n[WARNING] Got MOCK question - HF API may have failed")
        else:
            print("\n[VERIFIED] Real question from Hugging Face API")
